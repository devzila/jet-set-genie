    ...
    <div class="row">
        <div class="col-lg-12 col-sm-12">
            <div class="row form-group">
                ...
                <div class="col-lg-5 col-md-6">
                    <input type="text" class="tag_places form-control" data-ng-model="sparams.type" width="100%" required search-form />
            ...
            <div class="row form-group">
                <div class="col-lg-5 col-md-6">
                    <div class="input-group">
                        ...
                        <input type="text" id="leaving" class="form-control leavedate" name="leaving" data-ng-model="sparams.leaving" required search-form />
                    </div>
                </div>
                ...
                <div class="col-lg-5 col-md-6">
                    <div class="input-group">
                        ...
                        <input type="text" id="returning" class="form-control returndate" name="returning" data-ng-model="sparams.returning" required search-form />
                    </div>
                </div>

                <div class="col-lg-2 col-md-6">                   
                    <button class="btn btn-default jsg-submit" type="submit" ng-if="validForm" data-ng-click="refineSearch()">Search</button>
                    <button class="btn btn-disabled" ng-if="!validForm" >Search</button>
                </div>
            </div>
        </div>
    </div>
                ...
                <li class="duration">
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="duration">
                            <li>
                                <p><span class="pull-left">{{ searchfilters.duration[0] }}<span data-ng-show="searchfilters.duration[0] <= 1" data-ng-hide="searchfilters.duration[0] > 1">hr</span><span data-ng-hide="searchfilters.duration[0] <= 1" data-ng-show="searchfilters.duration[0] > 1">hrs</span></span> <span class="pull-right">{{ searchfilters.duration[1] < 48 ? searchfilters.duration[1] : 'NO LIMIT' }}<span data-ng-show="searchfilters.duration[1] <= 1" data-ng-hide="searchfilters.duration[1] > 1">hr</span><span data-ng-hide="searchfilters.duration[1] <= 1" data-ng-show="searchfilters.duration[1] > 1 && searchfilters.duration[1] < 47">hrs</span></span></p>
