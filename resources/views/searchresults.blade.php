        ...
        <div class="row row-centered search-results">
            <div class="col-md-9 left-part">
                <div class="row result-container">
                    <div class="col-md-4 col-sm-4 col-xs-6 list-box" data-ng-repeat="record in records | limitTo: lstCount" ng-init="parentIndex = $index">
                            ...
                            <div class="box-detail">
                                ...
                                <a class="lnkFlights" data-ng-click="showFlights( record.airport_code, record.display_name, record.id );">
                                    ...
                                    <div class="box-info row">
                                        ...
                                        <p class="col-xs-6">
                                            Shortest<span>@{{ record.duration | html }}</span>
                                        </p>
                                    </div>
                                </a>
                            </div>
